# Telegram News Bot с Claude AI

Профессиональный Telegram бот для автоматического сбора, анализа и публикации новостей в коротком новостном формате.

## Возможности

- Автоматический сбор новостей из RSS и NewsAPI
- Анализ и отбор топовых новостей через Claude AI
- Генерация коротких новостных постов (50-150 слов)
...
Сбор новостей → Анализ Claude → Генерация постов → Модерация → Публикация
     ↓              ↓                ↓                ↓            ↓
   RSS/API      Top N выбор    Короткие посты   Админ OK      Канал
```
...
### Контент
- Короткие новостные посты (50-150 слов)
- Стиль: прямо к делу, только факты
- Эмодзи флагов стран
...
Подробная инструкция по настройке канала @InsightAlert в файле [CHANNEL_SETUP.md](CHANNEL_SETUP.md)

## Автор

Создано для быстрой и оперативной новостной аналитики.
