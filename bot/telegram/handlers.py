...
/collect - Принудительный сбор новостей (через ИИ)
/publish - Опубликовать ваш контент (напишите /publish, потом отправьте контент)
/stats - Детальная статистика
/health - Проверка здоровья системы

🤖 Бот работает 24/7, автоматически собирает новости, анализирует через Claude AI и публикует 50-60 постов в сутки.

📝 Как опубликовать свой контент:
1. Напишите /publish
2. Отправьте текст, фото или видео
3. Контент опубликуется в канал без изменений"""
